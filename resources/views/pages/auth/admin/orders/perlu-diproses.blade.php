...
usesPagination();
name('orders.perlu-diproses');
with(fn () => ['orders' => Order::with('product')->where('status', 1)->paginate(10)]);
state(['selectedTab' => 'perlu-diproses-tab',
'headers' => [
...
?>
<x-dashboard-layout title="Perlu Diproses">
  @volt
  <div>
