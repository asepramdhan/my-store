...
usesPagination();
name('orders.sedang-diproses');
with(fn () => ['orders' => Order::with('product')->where('status', 2)->paginate(10)]);
state(['selectedTab' => 'sedang-diproses-tab',
'headers' => [
...
?>
<x-dashboard-layout title="Sedang Diproses">
  @volt
  <div>
