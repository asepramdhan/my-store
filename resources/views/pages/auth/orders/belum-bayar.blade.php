...
usesPagination();
name('orders.belum-bayar');
with(fn () => ['orders' => Order::with('product')->where('status', 0)->paginate(10)]);
state(['selectedTab' => 'belum-bayar-tab',
'headers' => [
...
?>
<x-dashboard-layout title="Belum Bayar">
  @volt
  <div>
